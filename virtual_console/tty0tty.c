...
#define DRAM_SHARED_MEM         0x583F00000 //0x3f200000  /* start address of shared memory region */
#define DRAM_SHARED_MEM_SIZE    0x1000 // Maximum memory of shared memory region (4k)

#define DRAM_SHARED_MEM_SIZE_TX  /*0xFFE00*/ 0xF00 //TX buffer size
#define DRAM_SHARED_MEM_SIZE_RX  /*0x100*/  0xF8  //RX_buffer_sixe
